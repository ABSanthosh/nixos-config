...
in
{
  ...
  home = {
    ...
    file.".config/hypr/hyprsunset.conf" = {
      force = true;
      text = ''
        [hyprsunset]
        lat = 40.0
  ...
  wayland.windowManager.hyprland = {
    ...
    extraConfig = ''
      ...
      windowrulev2 = float, class:^(rofi_launcher)$
      windowrulev2 = center, class:^(rofi_launcher)$
      windowrulev2 = size 800 600, class:^(rofi_launcher)$

      windowrulev2 = stayfocused, title:^()$,class:^(steam)$
      windowrulev2 = minsize 1 1, title:^()$,class:^(steam)$
      windowrulev2 = opacity 0.9 0.7, class:^(Brave)$
      windowrulev2 = opacity 0.9 0.7, class:^(nautilus)$
      windowrulev2 = group set, class:.*
      ...
      # Keybindings for group management
      ...
      bind = SUPER, SPACE, exec, rofi -show drun -name rofi_launcher
